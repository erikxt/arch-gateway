...
public class GatewayDiscoveryClientAutoConfiguration {
	...
	public static List<PredicateDefinition> initPredicates() {
		...
		predicate.addArg(PATTERN_KEY, "'/'+serviceId+'/websocket/**'");
	...
	@Bean
	public DiscoveryWsLocatorProperties discoveryWsLocatorProperties() {
		DiscoveryWsLocatorProperties properties = new DiscoveryWsLocatorProperties();
	...
	public static class ReactiveDiscoveryClientRouteDefinitionLocatorConfiguration {
		...
		@Bean
		@ConditionalOnProperty(name = "spring.cloud.gateway.discovery.ws.locator.enabled")
		public DiscoveryClientWsRouteDefinitionLocator discoveryClientWsRouteDefinitionLocator(
				ReactiveDiscoveryClient discoveryClient, DiscoveryWsLocatorProperties properties) {
			return new DiscoveryClientWsRouteDefinitionLocator(discoveryClient, properties);
		}
