...
@ConfigurationProperties("spring.cloud.gateway.discovery.ws.locator")
public class DiscoveryWsLocatorProperties {
	 ...
	 */
	private String urlExpression = "'lb:ws://'+serviceId";
